...
public class Activity9_15 extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity9_15);
        FrameLayout frameLayout = (FrameLayout) findViewById(R.id.frameLayout10);
    ...
    public class MyView extends View {
        ...
        public MyView(Context context) {
            ...
            BitmapShader shader = new BitmapShader(Bitmap.createScaledBitmap(
                    ...
                    bitmap_source.getHeight() * FACTOR, true), Shader.TileMode.CLAMP,
